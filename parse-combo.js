...
(async () => {
    ...
    try {
        ...
        const url = 'https://pizzanapolirsc.ru/?tfc_quantity%5B1271358691%5D=y&tfc_storepartuid%5B1271358691%5D=Комбо+наборы&tfc_div=:::';
        ...
        fs.writeFileSync(
            './raw-content/combo-from-site.json',
            JSON.stringify(result, null, 2),
            'utf8'
        );
        
        console.log('\n💾 Сохранено в: ./raw-content/combo-from-site.json\n');
