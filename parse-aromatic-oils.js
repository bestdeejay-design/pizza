...
console.log('🚀 Парсим АРОМАТНОЕ МАСЛО с pizzanapolirsc.ru...\n');

(async () => {
    let browser;
    try {
        console.log('🌐 Открываю категорию Ароматное масло...');
        ...
        const url = 'https://pizzanapolirsc.ru/?tfc_quantity%5B1271358691%5D=y&tfc_storepartuid%5B1271358691%5D=Ароматное+масло&tfc_div=:::';
        ...
        console.log('🔍 Собираю ароматные масла...\n');
        ...
        if (products.length === 0) {
            console.log('⚠️ Ароматные масла не найдены!\n');
        } else {
            console.log('🫒 АРОМАТНЫЕ МАСЛА:\n');
        ...
        fs.writeFileSync(
            './raw-content/aromatic-oils-from-site.json',
            JSON.stringify(result, null, 2),
            'utf8'
        );
        
        console.log('\n💾 Сохранено в: ./raw-content/aromatic-oils-from-site.json\n');
