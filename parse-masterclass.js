...
console.log('🚀 Парсим МАСТЕР КЛАСС с pizzanapolirsc.ru...\n');

(async () => {
    let browser;
    try {
        console.log('🌐 Открываю категорию Мастер класс...');
        ...
        const url = 'https://pizzanapolirsc.ru/?tfc_quantity%5B1271358691%5D=y&tfc_storepartuid%5B1271358691%5D=Мастер+класс&tfc_div=:::';
        ...
        console.log('👨‍🍳 Собираю мастер классы...\n');
        ...
        if (products.length === 0) {
            console.log('⚠️ Мастер классы не найдены!\n');
        } else {
            console.log('👨‍🍳 МАСТЕР КЛАССЫ:\n');
        ...
        fs.writeFileSync(
            './raw-content/masterclass-from-site.json',
            JSON.stringify(result, null, 2),
            'utf8'
        );
        
        console.log('\n💾 Сохранено в: ./raw-content/masterclass-from-site.json\n');
