...
console.log('🚀 Парсим КОНДИТЕРСКИЕ ИЗДЕЛИЯ с pizzanapolirsc.ru...\n');

(async () => {
    let browser;
    try {
        console.log('🌐 Открываю категорию Кондитерские изделия...');
        ...
        const url = 'https://pizzanapolirsc.ru/?tfc_quantity%5B1271358691%5D=y&tfc_page%5B1271358691%5D=5&tfc_storepartuid%5B1271358691%5D=Кондитерские+изделия&tfc_div=:::#rec1271358691';
        ...
        console.log('🔍 Собираю кондитерские изделия...\n');
        ...
        if (products.length === 0) {
            console.log('⚠️ Кондитерские изделия не найдены!\n');
        } else {
            console.log('🍰 КОНДИТЕРСКИЕ ИЗДЕЛИЯ:\n');
        ...
        fs.writeFileSync(
            './raw-content/confectionery-from-site.json',
            JSON.stringify(result, null, 2),
            'utf8'
        );
        
        console.log('\n💾 Сохранено в: ./raw-content/confectionery-from-site.json\n');
