...
console.log('🚀 Парсим ЗАМОРОЖЕННАЯ ПРОДУКЦИЯ с pizzanapolirsc.ru...\n');

(async () => {
    let browser;
    try {
        console.log('🌐 Открываю категорию Замороженная продукция...');
        ...
        const url = 'https://pizzanapolirsc.ru/?tfc_quantity%5B1271358691%5D=y&tfc_storepartuid%5B1271358691%5D=Замороженная+продукция&tfc_div=:::';
        ...
        console.log('🔍 Собираю замороженную продукцию...\n');
        ...
        if (products.length === 0) {
            console.log('⚠️ Замороженная продукция не найдена!\n');
        } else {
            console.log('❄️ ЗАМОРОЖЕННАЯ ПРОДУКЦИЯ:\n');
        ...
        fs.writeFileSync(
            './raw-content/frozen-from-site.json',
            JSON.stringify(result, null, 2),
            'utf8'
        );
        
        console.log('\n💾 Сохранено в: ./raw-content/frozen-from-site.json\n');
